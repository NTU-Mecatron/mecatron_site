      ...
      >
        {sections.map((section, index) => (
          <button
            ...
            className="px-4 sm:px-6 py-2.5 text-white bg-white/10 hover:bg-white/20 rounded-xl transition-all duration-300 text-sm sm:text-base font-medium border border-white/20 hover:border-white/40 hover:scale-105 active:scale-95 whitespace-nowrap"
          >
            {section.title}
          </button>
        ))}
...
function KevinPage() {
  ...
  return (
    <main ref={mainRef} className="overflow-x-hidden bg-black min-h-screen">
      ...
      {isPortrait && (
        <div className="fixed inset-0 z-[9999] bg-black/90 flex flex-col items-center justify-center text-center text-white text-2xl font-bold select-none">
          <svg className="w-20 h-20 mb-6 animate-bounce" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="7" width="18" height="10" rx="2"/><path d="M16 3l3 4-3 4"/></svg>
          Please rotate your device to landscape<br/>for the best experience.
        </div>
      )}
      {/* Static down arrow indicator for tab */}
      <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-50 pointer-events-none">
        <svg className="w-8 h-8 text-white opacity-70 animate-bounce" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      >
        ...
        <section className="relative flex items-center justify-evenly h-[100vh]">
          ...
          <div className="text-white w-[50%] text-center px-4">
            <h2 className="text-6xl font-bold mb-6">Manoeuvrability</h2>
        ...
        <section className="relative flex items-center justify-evenly h-[100vh]">
          <div className="text-white order-1 w-[50%] text-center px-4">
            <h2 className="text-6xl font-bold mb-6">Energy Efficiency</h2>
            <p className="text-4xl font-semibold">
        ...
        <section className="relative flex items-center justify-evenly h-[100vh]">
          <p className="w-[50%] border-0 border-red-700"></p>
          <div className="text-white w-[50%] text-center px-4">
            <h2 className="text-6xl font-bold mb-6">Unity simulation</h2>
            <p className="text-4xl font-semibold">
        ...
        <section className="relative flex items-center justify-evenly h-[100vh]">
          <div className="text-white order-1 w-[50%] text-center px-4">
            <h2 className="text-6xl font-bold mb-6">BT-based mission planner</h2>
            <p className="text-4xl font-semibold">
        ...
        <section className="relative flex items-center justify-evenly h-[100vh]">
          <p className="w-[50%] border-0 border-red-700"></p>
          <div className="text-white w-[50%] text-center px-4">
            <h2 className="text-6xl font-bold mb-6">Ardusub Controller Stack</h2>
            <p className="text-4xl font-semibold">
